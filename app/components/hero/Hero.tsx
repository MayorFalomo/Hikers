...
const Hero = (props: Props) => {
  ...
  function useMenuAnimation(isOpen: boolean) {
    ...
    //           ],
    //           ["nav",{ease: [0.08, 0.65, 0.53, 0.96]}, { transform: "translateX(100%)" }, { at: "-0.1" }]
    //         ];
    //     animate([
    //       ["path.top",{} ],["path.middle", { opacity: isOpen ? 0 : 1 }, { at: "<" }],[
    //         "path.bottom",
  ...
  // console.log(isOpen, "This is isOpen");
  
  // console.log(scope, "This is scoped");
